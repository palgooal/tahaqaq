...
<div class="package-container d-flex justify-content-center align-items-center">
    ...
    <div class="packages wow bounceInRight"
        ...
        <a onclick="planStartNow_Click('bronze')" class="btn primery-button start-now-btn py-2 px-5"
    ...
    <div class="packages res-star wow bounceInDown"
        ...
        <a onclick="planStartNow_Click('silver')" class="button index-sign-button py-2 px-5">ابدا الان</a>
    </div>
    <!-- End -->
    <!-- Start  -->
