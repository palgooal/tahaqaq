...
<div class="package-container d-flex justify-content-center align-itaems-center">
    ...
    <div class="packages res-star wow bounceInDown"
        ...
        <a href="https://client.tahqq.com/cart.php?a=add&pid={{$templateOne->whmcs_silver_pid}}&carttpl=cartx" class="button index-sign-button py-2 px-5">ابدا الان</a>
    </div>
    <!-- End -->
    <!-- Start  -->
    <div class="packages wow bounceInLeft"
        ...
        <a href="https://client.tahqq.com/cart.php?a=add&pid={{$templateOne->whmcs_gould_pid}}&carttpl=cartx" class="btn primery-button start-now-btn py-2 px-5">أبدا الان</a>
