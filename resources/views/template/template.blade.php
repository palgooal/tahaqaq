			...
			<div class="col-lg-1 colCategory">
				<div class="category">
					...
					<ul class="ClSc">
						<a href="/template">
							<li>الجميع</li>
						</a>@foreach ($categoris as $categoris)
						<li onclick="getDataTemplateCategory('{{$categoris->id}}')">{{$categoris->text_ar}}</li>@endforeach</ul>
				</div>
			</div>
			<div class="col-lg-11">
				<div class="row" id="contintTemplate">@foreach ($templateAll as $templateAll)
