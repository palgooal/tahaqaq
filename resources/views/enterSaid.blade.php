...
<section class=" p-5 pt-3 mx-5 d-flex align-items-center justify-content-between top-slider" style="margin-top: 100px;">
	...
	<div class=" wow fadeInDown ">
		<h1 class="h3 primery-color font-weight-bold call-us-head">ماذا تقول عن تحقق </h1>
	</div>
	<div class="mx-5"></div>
</section>
</header>
		...
		<div class=" d-grid py-5 px-2 ">
			<div class="row  ">
				<div class="col col-md-6 col-sm-12 col-xs-12 offset-md-1 text-right  lol">
					<p class="top-of-the-head mt-0 mb-3">ماذا تقول عنا</p>
					...
					<div class="  mt-5 text-right">
						<form class="pt-5" action="/pg-admin/said" method="POST" enctype="multipart/form-data" id="idContact">
							@csrf
							...
							<div class="form-group mb-4">
								<label for="exampleFormControlInput1">العمل</label>
								<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="هنا ماذا تعمل" name="work">
							</div>
							<div class="form-group mb-4">
								<label for="exampleFormControlInput1">صورة شخصية</label>
