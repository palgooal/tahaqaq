                                                  ...
                                                  <form method="POST" action="/pg-admin/menus" accept-charset="UTF-8" class="form-horizontal" role="form">
                                                    ...
                                                    <div class="form-body">
                                                      <div class="form-group">
                                                        ...
                                                        <input class="form-control spinner" type="text" placeholder="اكتب عنوان القائمة " name="name" required/>
                                                        <div class="aa">{{ $errors->first('name')}}</div>
                                                      </div>
                                                     
                                                      <div class="form-group">
                                                        <label>رابط القائمة</label>
                                                        <input class="form-control spinner" type="text" placeholder="كتابة رابط القائمة يبدأ http://" name="url" id="url" required/>
                                                        <div class="aa">{{ $errors->first('url')}}</div>
                                                      </div>
                                                      <div class="form-group">
                                                        <label>ترتيب القائمة</label>
                                                        <input class="form-control spinner" type="number" placeholder="ترتيب القائمة" name="sort" id="sort" required/>
                                                        <div class="aa">{{ $errors->first('sort')}}</div>
                                                      </div>
                                                    </div>
                                                    <div class="form-actions">
                                                      <button type="submit" class="btn btn-primary mr-2 btn-lg btn-block">اضافة</button>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">تحذير من حذف القائمة</h4>
        </div>
