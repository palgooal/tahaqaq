                        ...
                        <div class="d-flex flex-column-fluid">
                            ...
                            <div class="container">
                                ...
                                <div class="card card-custom">
                                    ...
                                    <form method="post" action="/pg-admin/menus/{{$menus->id}}" accept-charset="UTF-8" class="form-horizontal" role="form" >
                                        ...
                                        @csrf
                                          <div class="form-body">
                                              <div class="form-group">
                                                  ...
                                                  <input class="form-control spinner" type="text" placeholder="اكتب عنوان القائمة بالعربية" value="{{$menus->name}}" name="name" required/>                
                                                </div>
                                  
                                              <div class="form-group">
                                                <label>رابط عنوان القائمة </label>
                                              <input class="form-control spinner" type="text" placeholder="اكتب هنا رابط القائمة url http://" name="url" id="url" value="{{$menus->url}}" required>
                                  
                                              </div>
                                              <div class="form-group">
                                                <label>ترتيب القائمة</label>
                                              <input class="form-control spinner" type="number" placeholder="ترتيب القائمة" name="sort" value="{{$menus->sort}}" required>
                                            </div>
