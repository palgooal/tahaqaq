    ...
    <div class="col-xl-12">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                ...
                <div class="text-left">
                    <a type="button" class="btn btn-primary" href="/pg-admin/blogs/create">اضافة مدونة جديدة</a>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$blog->title_ar}}</td>
                                    <td><a type="button" class="btn btn-success" href="/blogs/{{$blog->slug}}">مشاهدة</a></td>
                                    <td><a type="button" class="btn btn-secondary" href="/pg-admin/blogs/{{$blog->id}}/edit">تعديل</a></td>
                                    <td><button type="button" class="btn btn-danger" data-pageid="{{$blog->id}}" data-toggle="modal" data-target="#deletepage">
                                    حذف
                                   </button>
                                </td>
                                    @endforeach
