			...
			اضافة مدونة جديدة
				...
				<form action="/pg-admin/blogs" method="POST">@csrf
					<div class="card-body">
						...
						</div>{{-- start modal gallery --}} @include('admin.partials.modalGallary'); {{-- end modal gallery --}}
					...
					<div class="card-footer">
						<div class="row">
							...
							<div class="col-lg-9">
								<button type="submit" class="btn btn-primary mr-2">اضافة</button>	<a type="reset" class="btn btn-secondary" href="/pg-admin/pages">الغاء </a>
							</div>
						</div>
					</div>
				</form>
