			...
			<div class="portlet light bordered">
				<div class="card card-custom">
					<div class="card-header">
                      ...
                      <span class="caption-subject font-green bold uppercase" >مكتبة الوسائط</span>
                  </h3>
                  ...
                  {{-- <div class="text-left">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1" data-whatever="@getbootstrap">تحميل صورة</button>
						...
						<a href="/pg-admin/addMediaModal" class="iconMediaHidden" data-toggle="tooltip" data-placement="top" title="رفع صورة<"رفع صورة <span class="svg-icon svg-icon-primary svg-icon-2x">
							<!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Outgoing-box.svg-->
					...
					</div>@include('alerts.delete') @include('alerts.success')
					<div class="portlet-body bodyImg">
						<div class="table-scrollable"> <span id="viewImg">
            </span>
						</div> <span id="alertCopty" class="text-right fixed-top alert alert-success" style="">تم النسخ</span>
						<hr class="mt-2 mb-5">
						<div class="row text-center text-lg-left">@foreach ($uploads as $upload)
							<div class="col-lg-2 col-md-4 col-sm-4 colViewImg">
								<form action="/pg-admin/upload/{{$upload->id}}" method="POST">@method('delete') @csrf
									<button type="submit" class="btn btn-danger font-weight-bold btn-pill" id="btnDeleteImage" data-emilid="{{$upload->id}}">حذف</button>
								</form>
								<div class="form-group">{{-- <span class="TrueSelect" id="{{$upload->path}}/trueIcon">✔</span> --}}
									<label>
