...
<div class="uploadMedia">{{--
	<div class="col-md-4 col-sm-12">--}}
                      ...
                      <div class="portlet-title">
                          <div class="caption font-red-sunglo">
                            ...
                            <span data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false"
                             aria-controls="collapseExample">اضافة صورة</span>
                          </div>
                        </div>
                  </h3>
			...
			<div class="" id="">
				<div class="card card-body">
					<div class="portlet-body form">
						<form method="POST" action="/pg-admin/upload" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" role="form">@csrf
							<div class="form-body">
		...
		</div>{{--</div>--}}</div>{{-- end form aupload media --}}
