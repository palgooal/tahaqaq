                   ...
                   <li class="menu-item  menu-item-active" aria-haspopup="true" >
                    <a  href="/pg-admin/menus" class="menu-link ">
                        <span class="symbol-label">
                            <span class="svg-icon svg-icon-lg svg-icon-danger"><!--begin::Svg Icon | path:assets/media/svg/icons/General/Attachment2.svg-->
                              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                 <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
               ...
               <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <div class="menu-submenu " style="display: none; overflow: hidden;" kt-hidden-height="120">
                   ...
                   <ul class="menu-subnav">
                      ...
                      <li class="menu-item " aria-haspopup="true">
                         <a href="/pg-admin/pages/templates" class="menu-link ">
                            <i class="menu-bullet menu-bullet-dot">
                               <span>
                               </span>
                            </i>
