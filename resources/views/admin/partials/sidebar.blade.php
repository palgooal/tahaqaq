		...
		<div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<ul class="menu-nav ">
						...
						<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
							...
							<div class="menu-submenu " style="display: none; overflow: hidden;" kt-hidden-height="120"> <i class="menu-arrow"></i>
								<ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
										<a href="/pg-admin/comment" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                <span>
                                                </span>
                                            </i>
						...
						<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
							<a href="javascript:;" class="menu-link menu-toggle"> <span class="svg-icon menu-icon">
								...
								<span class="menu-text">الاعضاء</span><i class="menu-arrow"></i>
							</a>
							<div class="menu-submenu " style="display: none; overflow: hidden;" kt-hidden-height="120"> <i class="menu-arrow"></i>
								<ul class="menu-subnav">
									<li class="menu-item" aria-haspopup="true">
										<a href="/pg-admin/users" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
											<span class="menu-text">كل الاعضاء</span>
										</a>
									</li>
									<li class="menu-item" aria-haspopup="true">
										<a href="/pg-admin/users/create" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                <span>
                                                </span>
                                            </i>
											<span class="menu-text">اضافة عضو جديد</span>
										</a>
									</li>
								</ul>
            ...
            <span class="svg-icon svg-icon-lg svg-icon-danger">
                ...
                <!--end::Svg Icon-->
                            ...
                            <li class="menu-item  menu-item-submenu" aria-haspopup="true">
                                <a href="/pg-admin/ourClient" class="menu-link ">
                                   ...
                                   <span class="menu-text">عملائنا</span>
                                </a>
                             </li>


                            <li class="menu-item  menu-item-submenu" aria-haspopup="true">
                                <a href="/pg-admin/said" class="menu-link ">
                                   <span class="symbol-label">
                                      <span class="svg-icon svg-icon-lg svg-icon-danger">
                                         <!--begin::Svg Icon | path:assets/media/svg/icons/General/Attachment2.svg-->
                                         <svg xmlns="http://www.w3.org/2000/svg"
                                   ...
                                   <span class="menu-text">ماذا قالو عن تحقق</span>
                                </a>
                             </li>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle"> <span class="svg-icon menu-icon">
                                    ...
                                    <span class="menu-text">المظهر</span><i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu " style="display: none; overflow: hidden;" kt-hidden-height="120"> <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/pg-admin/sysVars_editAsCards/Setting" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/pg-admin/sysVars_editAsCards/Header" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                    <span>
                                                    </span>
                                                </i>
                                                <span class="menu-text">الهيدر</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/pg-admin/sysVars_editAsCards/Why%20Tahaqaq" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                    <span>
                                                    </span>
                                                </i>
                                                <span class="menu-text">لماذا تحقق</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/pg-admin/sysVars_editAsCards/Tahaqaq%20Info%201" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                    <span>
                                                    </span>
                                                </i>
                                                <span class="menu-text">1 مميزاتنا</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/pg-admin/sysVars_editAsCards/Tahaqaq%20Info%202" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                    <span>
                                                    </span>
                                                </i>
                                                <span class="menu-text">مميزاتنا 2</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/pg-admin/sysVars_editAsCards/Tahaqaq%20Info%203" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                    <span>
                                                    </span>
                                                </i>
                                                <span class="menu-text">مميزاتنا 3</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/pg-admin/sysVars_editAsCards/Tahaqaq%20Info%204" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                    <span>
                                                    </span>
                                                </i>
                                                <span class="menu-text">مميزاتنا 4</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/pg-admin/sysVars_editAsCards/Footer" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                    <span>
                                                    </span>
                                                </i>
                                                <span class="menu-text">الفوتر</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="/pg-admin/sysVars_editAsCards/Social%20Media" class="menu-link "> <i class="menu-bullet menu-bullet-dot">
                                                    <span>
                                                    </span>
                                                </i>
                                                <span class="menu-text">التواصل الاجتماعي</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                {{-- start Contact us --}}
							<li class="menu-item  menu-item-submenu" aria-haspopup="true">
								<a href="/pg-admin/packges" class="menu-link "> <span class="symbol-label">
            <span class="svg-icon svg-icon-lg svg-icon-danger">
                <!--begin::Svg Icon | path:assets/media/svg/icons/General/Attachment2.svg-->
                <svg xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                ...
                <!--end::Svg Icon-->
									...
									</span> <span class="menu-text">الباقات</span>
								</a>
                            </li>
					</ul>
					<!--end::Menu Nav-->
