    ...
    <div class="row">
        ...
        <!--begin::Card-->
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <form method="POST" action="/pg-admin/templateCategories" accept-charset="UTF-8" class="form-horizontal" role="form">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="text_ar" class="form-control" placeholder="تصنيف باللغة العربية">
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                            ...
                            <tbody>
                                ...
                                @include('admin.templateCategories.editCategory')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger" data-categoryid="{{$category->id}}" data-toggle="modal" data-target="#deletecategory">
                                            حذف
                                        </button>
                                    </td>
                                    @endforeach
                                    ...
                                    <div class="modal fade" id="deletecategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="{{route('templateCategories.destroy', 'test')}}" method="post">
                                            @method('delete')
                                            @csrf
