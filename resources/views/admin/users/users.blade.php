                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="card card-custom gutter-b">
                                                <div class="card-header">
                                                    ...
                                                    <div class="text-left">
                                                        <a type="button" class="btn btn-primary" href="/pg-admin/users/create">اضافة عضو جديدة</a>
                                                    </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><a type="button" class="btn btn-secondary" href="/pg-admin/users/{{$user->id}}/edit">تعديل</a></td>
                                                                        <td><button type="button" class="btn btn-danger" data-pageid="{{$user->id}}" data-toggle="modal" data-target="#deletepage">
                                                                        حذف
                                                                       </button>
                                                                    </td>
                                                                        @endforeach
