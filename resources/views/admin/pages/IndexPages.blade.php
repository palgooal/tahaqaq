    ...
    <div class="col-xl-12">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                ...
                <div class="text-left">
                    <a type="button" class="btn btn-primary" href="/pg-admin/pages/create">اضافة صفحة جديدة</a>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$page->title_ar}}</td>
                                    <td><a type="button" class="btn btn-success" href="/pages/{{$page->slug}}">مشاهدة</a></td>
                                    <td><a type="button" class="btn btn-secondary" href="/pg-admin/pages/{{$page->id}}/edit">تعديل</a></td>
                                    <td><button type="button" class="btn btn-danger" data-pageid="{{$page->id}}" data-toggle="modal" data-target="#deletepage">
                                    حذف
                                   </button>
                                </td>
                                    @endforeach
