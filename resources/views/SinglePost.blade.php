            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption carousel-caption-format d-none text-center d-md-block">
                        <div class=" w-25 p-0 pt-2 " style="background: #F582EA 0% 0% no-repeat padding-box;
                            ...
                            <div class="col-md-8 col-sm-6 ">
                                <div class="card-body">
                                    <div class="gray-color ">
                                        ...
                                        <small class="text-muted mr-3">{{$blogersSidepar->created_at->format('Y-m-d')}}</small>
                                    </div>
                                    <a href="/blogs/{{$blogersSidepar->slug}}"><h6 class="card-title black-color mt-4 m-0">{{$blogersSidepar->getTitle(App::getLocale())}}</h6></a>
