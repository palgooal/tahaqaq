                ...
                <form>
                        ...
                        <form role="form" method="POST" style="margin-top: 16px !important;">
                            ...
                            <div class="panel panel-primary setup-content" id="step-1"
                                ...
                                <div class="panel-body d-grid">
                                    ...
                                    <!-- <div class="form-row d-flex justify-content-center align-items-center mt-5 p-5"> -->
                                        ...
                                        <button
                                        class="btn primery-button d-flex align-items-center w-25 res-button  mt-5 nextBtn  pull-right py-4"
                                        style="float: left !important; margin-left: 38%; padding-right: 56px;" type="button">
                                        انشاء حساب
                            ...
                            <div class="panel panel-primary setup-content" id="step-2"
                             ...
                             -->
                                    ...
                                    <button     class="btn primery-button d-flex align-items-center w-25 res-button  mt-5 nextBtn  pull-right py-4"
                            ...
                            <div class="card mb-2">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class=" hover-state">
                                                                        ...
                                                                        <div class="middle">
                                                                            ...
                                                                            <button class="btn primery-button">تفاصيل
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                ...
                                <div class="container mt-5 pt-5 d-none" id="details" detailsTemplateSelector>
                                    <p id="idTemplateSelector">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt ab, quod
                                        officiis
                                        molestiae aspernatur voluptates qui ullam nam cum laborum repudiandae labore
                                        dolores
                                        ad,
                                        necessitatibus dignissimos itaque voluptas. A hic labore quas soluta consequatur
                                        non
                                        tenetur
                                        voluptate, accusamus quaerat quos ratione tempora aspernatur quod. Rerum
                                        exercitationem
                                        deserunt quia ex aut.
                                    </p>
                        ...
                        <div class="panel-body">
                            <div class="container" style="padding-left:40px !important">
                                ...
                                <div class="package-item container d-grid">
                                    <!-- Start  -->
                                    <div class="col col-lg-3 col-md-4 mb-5 ml-3 "
                                    ...
                                    <!-- End -->
                                    <!-- Start  -->
                                    <div class="col col-lg-3 col-md-4 mb-5 offset-1 "
                                        style="border: 1px solid rgb(209, 209, 209);border-radius: 20px !important;  background: #fff;">
                                        <h1 class="primery-color mb-3 text-center">الباقة البرونزية</h1>
                                        <div class="bg-primery py-2 my-5 text-center " style="border-radius: 40px;">
                                            <h5 class="">423 ريال سعودي</h5>
                            ...
                            <button
                            class="btn primery-button d-flex align-items-center w-25 res-button  mt-5 nextBtn  pull-right py-4"
                            style="float: left !important; margin-left: 38%; padding-right: 70px;" type="button">
                            متابعة
                            <div style="border-radius: 10px; margin-right: 58px;"> <i
                                    class="fas fa-chevron-left mr-4"></i></div>
                        </button>
                    ...
                    <div class="panel panel-primary setup-content" id="step-5"
                        ...
                        <div class="panel-body">
                                ...
                                <div class="row res-col">
                                    <div class="col mt-5">
                                        ...
                                        <ul class="list-group list-set"
                                            ...
                                            <li class="list-group-item"> <img class="ml-3" src="img/1.png"> قالب موقع
                                                يربط
                                                بين طرفين</li>
                                            <li class="list-group-item"> <img class="ml-3" src="img/2.png">قالب موقع
                                                يربط
                                                بين طرفين </li>
                                            <li class="list-group-item"> <img class="ml-3" src="img/3.png"> قالب موقع
                                                يربط
                                                بين طرفين </li>
                                            <li class="list-group-item"> <img class="ml-3" src="img/4.png"> قالب موقع
                                                يربط
                                                بين طرفين </li>
                                            <li class="list-group-item"> <img class="ml-3" src="img/5.png"> قالب موقع
                                                يربط
                                                بين طرفين </li>
                                        </ul>
                            ...
                            <button
                                class="btn btn-success primery-button d-flex align-items-center justify-content-center w-25  mt-5 nextBtn  pull-right py-4"
                                style="float: left !important; margin-left: 38%;" type="button">
                                ابدء الان
                            </button>
                        </div>
                    </div>
