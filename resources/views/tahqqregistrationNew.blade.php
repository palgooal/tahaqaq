...
<div class=" pt-5" style="background: transparent!important;margin-top: 120px;">
    ...
    <div class="container">
                ...
                <form>
                    <div class="container">
                        ...
                        <form role="form" method="POST" style="margin-top: 16px !important;">
                            ...
                            <div class="panel panel-primary setup-content border-0" id="step-2"
                                style="background: none !important">

                                <div class="panel-body">
                                    <div class="container form-group">
                                        <label class="control-label">اسم المشروع</label>
                                        <input maxlength="200" type="text" required="required" class="form-control py-4"
                            ...
                            <div class="panel panel-primary setup-content" id="step-4"
                                ...
                                <div class="panel-body">
                                    <div class="" style=" !important">
                                        <div
                                            class="d-flex justify-content-center align-items-center primery-color my-5">

                                            <h1>باقات الاشتراك في تحقق</h1>
                                        </div>
                                        <div class="package-item  d-grid" style="padding-right: 90px !important;">
                                    ...
                                    <button
                                        class="btn primery-button d-flex align-items-center  res-button  mt-5 nextBtn  pull-right py-3"
                                        style="float: left !important; margin-left: 42%; padding-right: 70px;"
                                        type="button">
                                        متابعة
                                        <div style="border-radius: 10px; margin-right: 58px;"> <i
                                                class="fas fa-chevron-left mr-4"></i>
                            ...
                            <div class="panel panel-primary setup-content" id="step-5"
                                ...
                                <div class="panel-body">
                                    ...
                                    <button
                                        class="btn btn-success primery-button w-25 d-flex align-items-center justify-content-center  mt-5 nextBtn  pull-right py-3"
        ...
        <!--  البوب اب للقالب التجريبي الثاني-->
        ...
        <!--  البوب اب للقالب التجريبي الثالث-->
        <div class="modal fade" id="pop-1" tabindex="-1" aria-labelledby="login" aria-hidden="true"
            style="overflow: hidden !important;">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
        ...
        <!--  البوب اب للقالب التجريبي الرابع -->
        <div class="modal fade" id="pop-1" tabindex="-1" aria-labelledby="login" aria-hidden="true"
            style="overflow: hidden !important;">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
        ...
        <!--  البوب اب للقالب التجريبي الخامس-->
        <div class="modal fade" id="pop-1" tabindex="-1" aria-labelledby="login" aria-hidden="true"
            style="overflow: hidden !important;">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
